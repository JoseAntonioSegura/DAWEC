document.addEventListener("DOMContentLoaded", function () {
  ...
  const comparePokemon = async () => {
    try {
      ...
      const imageRow = comparisonTable.insertRow();
      const imageCell1 = imageRow.insertCell(0);
      imageCell1.textContent = 'Pokémon';
      const imageCell2 = imageRow.insertCell(1);
      imageCell2.innerHTML = `<img src="${await getPokemonImage(pokemon1Name)}" alt="${pokemon1Name}" class="pokemon-image">`;
      const imageCell3 = imageRow.insertCell(2);
      imageCell3.innerHTML = `<img src="${await getPokemonImage(pokemon2Name)}" alt="${pokemon2Name}" class="pokemon-image">`;
